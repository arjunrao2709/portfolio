...
export const caseStudies: CaseStudy[] = [
  {
    ...
    myImpact: [
      'Built the design function from scratch, establishing the standards, practices, and culture that everything else grew from.',
      'Set up a research practice that gave the team a genuine picture of users before any design decisions were made.',
    ...
    images: [
      ...
      { src: '/projects/stylepass/after-1.png', caption: 'after:See it on you' },
      { src: '/projects/stylepass/after-2.png', caption: 'after:Photo confirmation' },
      { src: '/projects/stylepass/after-3.png', caption: 'after:Try-on result' },
      { src: '/projects/stylepass/after-4.png', caption: 'after:Stylebook' },
    ],
  },
  {
    id: 'theklub',
    ...
    myImpact: [
      'Shaped the product strategy and roadmap from the ground up, translating a founder\'s vision into a sequenced plan the whole team could execute against.',
      'Established research practices across qualitative and quantitative methods, giving the team a shared foundation for understanding users before building for them.',
      'Ran weekly sprint cycles centred on experimentation and learning, keeping the team moving fast while staying grounded in what was actually working.',
      'Designed and documented a design system that unified brand and product, giving a small team the leverage of a much larger one.',
      'Mentored junior designers and engineers, creating space for them to grow into owners rather than just executors.',
      'Built and managed partnerships with travel agents and influencers, securing the first trip supply and the trust of early communities.',
    ],
    images: [],
